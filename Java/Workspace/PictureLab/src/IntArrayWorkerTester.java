public class IntArrayWorkerTester
{
  ...
  public static void testGetColTotal()
  {
    ...
    System.out.println("testGetColTotal = Total for column 0 should be 5 and is " + total);
    total = worker.getColTotal(1);
    System.out.println("testGetColTotal = Total for column 1 should be 7 and is " + total);
    total = worker.getColTotal(2);
    System.out.println("testGetColTotal = Total for column 2 should be 9 and is " + total);
  }
